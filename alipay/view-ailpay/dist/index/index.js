...
_Component({
    ...
    methods: {
        ...
        _updateDataChange() {
            let indexItems = [];
            indexItems =
                this.getRelationNodes("../index-item/index") ||
                this.selectAllComponents(".i-index-item");
            ...
            if (len > 0) {
                ...
                this.data.timer = setTimeout(() => {
                    ...
                    indexItems.forEach(item => {
                        if (
                            item.data.name &&
                            fixedData.indexOf(item.data.name) === -1
                        ) {
        ...
        handlerScroll(event) {
            ...
            const indexItems =
                this.getRelationNodes("../index-item/index") || this.dataStore;
