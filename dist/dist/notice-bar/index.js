...
_Component({
  ...
  methods: {
    initAnimation() {
      _my.createSelectorQuery().in(this).select(".i-noticebar-content-wrap").boundingClientRect(wrapRect => {
        _my.createSelectorQuery().in(this).select(".i-noticebar-content").boundingClientRect(rect => {
